"""
Bundle-aware Flask app factory.

This module provides create_app() which builds the Flask app with paths
that work both in development and inside a PyInstaller .app bundle.
When the app is frozen, template/upload/results directories come from
environment variables set by launcher.py.
"""
...
def create_app():
    ...
    # Template directory — from env (bundle) or default (development)
